...
def make_targets(children, rewards, params):
    ...
    """
    # vals = apply_fun(params, children) + rewards   # --> not very fast due to memory overflow
    ...
    for e in range(num_epochs):
        ...
        for it in range(num_iterations):
            ...
            for i in range(num_samples):
                ...
                total_loss += loss
                if it == 0 and i == 0:
                    loss_history["first_loss"].append(float(loss))
            ...
            loss_history["iter_loss"].append(float(iter_mean_loss))
